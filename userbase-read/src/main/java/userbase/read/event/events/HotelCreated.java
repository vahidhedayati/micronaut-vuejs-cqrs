package userbase.read.event.events;


import com.sun.istack.Nullable;
import userbase.read.event.commands.HotelCreateCommand;
import userbase.read.event.commands.HotelRoomsCreateCommand;
...
public class HotelCreated extends EventRoot {
    ...
    public HotelCreated(HotelCreateCommand cmd) {
        super(cmd);
        ...
        this.setHotelRooms(cmd.getHotelRooms());
    }
